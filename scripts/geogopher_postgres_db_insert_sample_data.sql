...
INSERT INTO games (game_id,	game_name,	game_data,	game_center_coords,	game_zoom,	max_count_polygons, base_time) VALUES (1, "World Countries", "https://www.jasonbase.com/things/yKxG.json", "{lat: 30.0, lng: 31.0}", 4, 195, "17:00");
INSERT INTO games (game_id,	game_name,	game_data,	game_center_coords,	game_zoom,	max_count_polygons, base_time) VALUES (2, "South America", "https://www.jasonbase.com/things/yKxG.json", "{lat: 8.7832, lng: 55.4915}", 4, 12, "3:00");
INSERT INTO games (game_id,	game_name,	game_data,	game_center_coords,	game_zoom,	max_count_polygons, base_time) VALUES (3, "Africa", "https://www.jasonbase.com/things/yKxG.json", "{lat: 8.7832, lng: 34.5085}", 4, 54, "10:00");
INSERT INTO games (game_id,	game_name,	game_data,	game_center_coords,	game_zoom,	max_count_polygons, base_time) VALUES (4, "Europe", "https://www.jasonbase.com/things/yKxG.json", "{lat: 54.5260, lng: 15.2551}", 4, 51, "9:45");


INSERT INTO game_types (game_type_id, game_type_name) VALUES (1, "Countdown");
INSERT INTO game_types (game_type_id, game_type_name) VALUES (2, "Name The Country");
INSERT INTO game_types (game_type_id, game_type_name) VALUES (3, "Capital to Country");
INSERT INTO game_types (game_type_id, game_type_name) VALUES (4, "Country to Capital");
...
INSERT INTO game_difficulties (game_difficulty_id, game_difficulty_name,	game_time_manipulation) VALUES (4, "1 min", "{override: '1:00'}");
INSERT INTO game_difficulties (game_difficulty_id, game_difficulty_name,	game_time_manipulation) VALUES (5, "3 min", "{override: '3:00'}");
INSERT INTO game_difficulties (game_difficulty_id, game_difficulty_name,	game_time_manipulation) VALUES (6, "5 min", "{override: '5:00'}");
INSERT INTO game_difficulties (game_difficulty_id, game_difficulty_name,	game_time_manipulation) VALUES (7, "10 min", "{override: '10:00'}");


INSERT INTO scores (score_id, user_id,	count_polygons_identified,	game_id,	time_taken, when_game_played, game_difficulty_id, game_type_id, ip_where_played) VALUES (1 ,2 ,100, 1, "17:00", "2017-11-11 10:23:54+02", 1, 1, "1.127.34.56");
INSERT INTO scores (score_id, user_id,	count_polygons_identified,	game_id,	time_taken, when_game_played, game_difficulty_id, game_type_id, ip_where_played) VALUES (2 ,4 ,10, 2, 10, "1:30", "2017-11-10 10:23:54+02", 1, 1, "1.127.34.56");
INSERT INTO scores (score_id, user_id,	count_polygons_identified,	game_id,	time_taken, when_game_played, game_difficulty_id, game_type_id, ip_where_played) VALUES (3 ,3 ,32, 3, 32, "12:54", "2017-11-09 10:23:54+02", 1, 1, "1.127.34.56");
INSERT INTO scores (score_id, user_id,	count_polygons_identified,	game_id,	time_taken, when_game_played, game_difficulty_id, game_type_id, ip_where_played) VALUES (4 ,1 ,150, 1, 150, "23:13", "2017-11-08 10:23:54+02", 1, 1, "1.127.34.56");
